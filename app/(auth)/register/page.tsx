    ...
    <div className="w-full flex flex-col gap-10">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="space-y-2.5">
          <Label htmlFor="name" className="text-gray-700 font-semibold text-sm ml-1">Full Name</Label>
          <div className="relative group">
            <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 group-focus-within:text-[#40A853] transition-colors duration-300" />
            <Input 
              id="name" 
          ...
          {errors.name && <p className="text-sm text-red-500 ml-1 font-medium animate-in slide-in-from-top-1">{errors.name.message}</p>}
        </div>
        ...
        <div className="space-y-2.5">
          <Label htmlFor="password" className="text-gray-700 font-semibold text-sm ml-1">Password</Label>
          <div className="relative group">
      ...
      <p className="text-center text-[15px] text-gray-600 font-medium">
        ...
        <Link href="/login" className="text-[#40A853] hover:text-[#2E7D32] hover:underline font-bold transition-colors">
          Sign in
        </Link>
      </p>
    </div>

  ...
  return (
    <div className='w-full max-w-[700px] bg-white rounded-[20px] shadow-sm border border-[#E5E7EB] overflow-hidden'>
      ...
      <div className='p-10 space-y-8'>
        <div className='flex flex-col md:flex-row justify-between items-start md:items-center p-6 bg-[#ffffff] rounded-[12px] border border-[#F3F4F6]'>
          <div>
        ...
        <div className='space-y-6'>
          <h3 className='text-[18px] font-bold text-[#1A1A1A] font-montserrat border-b border-gray-100 pb-3'>
            What happens next?
          </h3>
          <ul className='space-y-4'>
            <li className='flex gap-4'>
              <div className='w-8 h-8 rounded-full bg-[#F3F4F6] text-[#4B5563] flex items-center justify-center font-bold shrink-0'>
                1
              </div>
              <p className='text-[15px] text-[#4B5563] font-lato pt-1 leading-relaxed'>
                Our team will review your request and vehicle availability for your selected dates.
              </p>
            </li>
            <li className='flex gap-4'>
              <div className='w-8 h-8 rounded-full bg-[#F3F4F6] text-[#4B5563] flex items-center justify-center font-bold shrink-0'>
            ...
            <li className='flex gap-4'>
              ...
              <p className='text-[15px] text-[#4B5563] font-lato pt-1 leading-relaxed'>
                Once confirmed, you can track your booking status directly from your dashboard.
              </p>
            </li>
          </ul>
        </div>

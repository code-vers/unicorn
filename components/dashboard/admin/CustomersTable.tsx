        ...
        <table className='w-full text-left border-collapse min-w-[1000px]'>
          <thead>
            <tr className='bg-[#FAFBFC] border-b border-[#E8ECF0] h-[50px]'>
              ...
              <th className='px-3 py-2 text-[#A0AEC0] text-[12px] font-normal font-lato uppercase w-[152px]'>Email</th>
              <th className='px-3 py-2 text-[#A0AEC0] text-[12px] font-normal font-lato uppercase w-[152px]'>Phone</th>
              <th className='px-3 py-2 text-[#A0AEC0] text-[12px] font-normal font-lato uppercase w-[134px]'>Total Bookings</th>
                ...
                <td className='px-3 py-2'>
                  <div className='flex items-center gap-2'>
                    <div className='w-[30px] h-[30px] rounded-[8px] bg-[rgba(63,163,77,0.09)] flex items-center justify-center'>
                      <span className='text-[10px] font-bold text-[#3FA34D] font-montserrat'>{customer.initials}</span>
                    </div>
                    <span className='text-[12px] font-semibold text-[#1A202C] font-lato'>{customer.name}</span>
                  </div>
                </td>
                <td className='px-3 py-2 text-[12px] font-semibold text-[#0A1413] font-lato'>{customer.email}</td>
                <td className='px-3 py-2 text-[12px] font-semibold text-[#0A1413] font-lato'>{customer.phone}</td>
                <td className='px-3 py-2 text-[12px] text-[#6B7280] font-lato'>{customer.totalBookings}</td>
                <td className='px-3 py-2'>
                  <span className='inline-flex items-center justify-center px-2 py-0.5 rounded-[5px] text-[10px] font-normal min-w-[50px] bg-[#EBF7ED] text-[#3FA34D]'>
                    {customer.status}
                  </span>
                </td>
                <td className='px-3 py-2'>
